...
public class JwtProvider {
    ...
    public String generateAccessToken(Client client) {
        return Jwts.builder()
                ...
                .setPayload(createPayload(client, jwtAccessExpiration))
                .compact();
    }
    ...
    public String generateRefreshToken(Client client) {
        return Jwts.builder()
                ...
                .setPayload(createPayload(client, jwtRefreshExpiration))
                .compact();
    }
    ...
    private String createPayload(Client client, long expiration) {
        try {
            return objectMapper.writeValueAsString(
                    JwtAuthenticationDto.builder()
                            .user(client.getId())
                            .claims(getRolesNames(client))
    ...
    private List<String> getRolesNames(Client client) {
